...
public class Usuarios extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        Estado.setBackground(new java.awt.Color(58, 179, 28));
        ...
        jPanel1.add(Estado, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 80, 97, 38));
        ...
        Eliminar1.setBackground(new java.awt.Color(58, 179, 28));
        ...
        jPanel1.add(Eliminar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 80, 97, 38));
    ...
    usuario.cambiarEstadoUsuario(jTable2); // Asegúrate de que el nombre coincida con tu JTable
    usuario.mostrarUsuarios(jTable2); // Para refrescar la tabla y actualizar los colore
